...
class AccLogo extends React.Component {
    ...
    render() {
        return (
            <span className="acclogo">
        <svg style={{ display: 'block', width: '250px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 447.8 111.1">
            <path style={{fill: `${this.props.color}`}}
                  d="M100.1 11.1C90.2 5.8 76.2.7 50.7.7 26.1.7 13.2 5.2 1.3 11c-1.1.6-1.5 42.5 9.9 64.8 12.1 23.5 28.5 29.8 39.5 34.5 11-4.7 27.4-10.9 39.5-34.5 11.4-22.2 11-64.1 9.9-64.7z"/>
            <linearGradient id="a" x1="19.3484" x2="88.0685" y1="-3.5153" y2="87.4067" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#3265ad"/>
              <stop offset=".1524" stopColor="#2f5ea3"/>
              <stop offset="1" stopColor="#1d3561"/>
            </linearGradient>
        <path fill="url(#a)"
              d="M50.7 111.1l-1.5-.6C38.5 106 22.3 99.1 10.5 76.2-.6 54.4-.6 14.3.5 11c0-.1.1-.5.5-.6C14 4 26.9 0 50.7 0c26.8 0 40.7 5.6 49.7 10.4 1.5.8.9 16.4.1 25-1.1 12-3.6 28.9-9.7 40.8-11.8 22.9-28 29.8-38.7 34.3l-1.4.6zM1.8 11.6C1 14.8.7 53.9 11.8 75.5c11.5 22.5 26.8 28.9 37.9 33.6l.9.4.9-.4c11.2-4.7 26.5-11.1 38-33.6 11.1-21.6 10.8-60.8 10-63.9C90.6 6.9 77 1.5 50.7 1.5c-23.4 0-36.1 3.8-48.9 10.1zm97.9.1zm-.2-.2z"/>
        <g>
        <linearGradient id="b" x1="23.7669" x2="84.8036" y1="3.2068" y2="83.9632" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#3265ad"/>
            <stop offset=".1524" stopColor="#2f5ea3"/>
            <stop offset="1" stopColor="#1d3561"/>
            </linearGradient>
        <path fill="url(#b)"
              d="M97.6 13.3c-9.4-5-22.7-9.8-46.9-9.8-23.4 0-35.6 4.2-46.9 9.8-1.1.5-1.4 40.3 9.4 61.5 11.4 22.3 27.1 28.3 37.5 32.7 10.4-4.4 26-10.4 37.5-32.7C99 53.7 98.6 13.9 97.6 13.3zM27 61.2s-.7-8.1-.5-9.4c1.9-9.3 45.3-13 58.9-13.6 0 .1-53.1 8.7-58.4 23zM26.1 47s-.9-7.1 1.1-8.3c3.9-2.4 39-5.3 61.9-1.8 0 0-57.3.7-63 10.1zm-2.4-11.5c0 13.1 1.6 31.7 7.4 56.7 0 0-8.8-19.1-9.7-55.3v-1c-6.6 1.1-9.8 2-10.3 1.4-1.1-1.5-7-3.7 10.2-5.2C20.7 1.4 23.1 9 25 10.2c1 .6-.9 7.4-1.2 21.7 3.6-.3 8-.5 13.5-.7 35.2-1.3 56 4.5 56 4.5-35-4.3-57.2-2.2-69.6-.2z"/>
        </g>
        <path fill="#A1A2A1"
              d="M27 61.2s-.3-3-.4-5.7c-.1-1.7 8.3-9.7 58.8-17.3 0 .1-53.1 8.7-58.4 23zM26.1 47s-.1-1.1-.2-2.5c-.1-2.2 19.5-8 63.2-7.6 0 0-57.3.7-63 10.1z"/>
            {/*<g style={{ fill: `${props.color}` }}>*/}
            <g style={{fill: `${this.props.color}`}}>
            <path
